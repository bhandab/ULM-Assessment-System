...
export const createCycle = cycleName => dispatch => {
  axios
    ...
    .then(() =>
      toastr.success("Cycle Created!", `Assessment Cycle Successfully Created!`)
    )
    .then(() => dispatch(getAssessmentCycles()))
    .catch(err => {
      const message = err.response.data.cycleDescription;
      toastr.error("Delete Fail!", message);
      dispatch({
        type: GET_ERRORS,
        payload: err.response.data
      });
...
export const linkOutcomeToCycle = (cycleID, outcome) => dispatch => {
  axios
    ...
    .catch(err => {
      ...
      toastr.error("Failed to Create Outcome!", message);
      dispatch({
        type: GET_ERRORS,
        payload: err.response.data
      });
...
export const linkMeasureToOutcome = (
  cycleID,
  outcomeID,
  details
) => dispatch => {
  axios
    ...
    .catch(err => {
      ...
      toastr.error("Measure could not be created!", message);
      dispatch({
        type: GET_ERRORS,
        payload: err.response.data
      });
  ...
  axios
    ...
    .then(() =>
      window.location.assign(
        `/admin/cycles/cycle/${cycleID}/outcomes/${learnID}`
      )
    )
    .catch(err =>
      dispatch({
...
export const updateMeasure = (
  ...
  axios
    ...
    .then(() =>
      toastr.success("Updated!", "Performance Measure Successfully Updated!")
    )
...
export const getOutcomesMeasures = (cycleID, outcomeID) => dispatch => {
...
export const updateCycleName = (cycleID, body) => dispatch => {
  axios
    ...
    .then(() =>
      toastr.success("Updated!", "Assessment Cycle Successfully Updated!")
    )
    .then(() => dispatch(getAssessmentCycles()))
    .catch(err => {
      dispatch({
...
export const deleteCycle = cycleID => dispatch => {
  axios
    ...
    .then(() =>
      toastr.success("Deleted!", "Assessment Cycle Successfully Deleted!")
    )
    .then(() => dispatch(getAssessmentCycles()))
    .catch(err => {
...
export const updateOutcomeName = (cycleID, outcomeID, body) => dispatch => {
  axios
    ...
    .then(() =>
      toastr.success("Updated!", "Learning Outcome Successfully Updated!")
    )
...
export const deleteOutcome = (cycleID, outcomeID) => dispatch => {
  axios
    ...
    .then(() =>
      toastr.success("Deleted!", "Learning Outcome Successfully Deleted!")
    )
    .then(() => dispatch(getCycleMeasures(cycleID)))
    .catch(err => {
...
export const deleteEvaluator = (measureID, measureEvalID) => dispatch => {
  axios
    .post("/api/cycles/" + measureID + "/deleteMeasureEvaluator", {
      measureEvalID
    })
    .then(() =>
      toastr.success(
...
export const addStudentToMeasure = (measureID, body) => dispatch => {
  axios
    ...
    .then(() =>
      toastr.success("Student Added!", "Student Successfully Added To Measure!")
    )
    .then(() => dispatch(getStudentsOfMeasure(measureID)))
    .catch(err => {
      const message = err.response.data.evaluatorEmail;
...
export const addStudentsToMeasure = (
  measureID,
  formData,
  config
) => dispatch => {
