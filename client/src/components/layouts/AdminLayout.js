            ...
            <Fragment>
                <header>
                    ...
                    <ul className="utilities">
                        ...
                        <li className="logout warn"><Link onClick = {this.onLogoutClick.bind(this)}>Log Out</Link></li>
                    </ul>
                </header >
                ...
                <nav>
                    <ul className="main">
                        ...
                        <li className="perf-measures"><Link to="/admin/perf-measures">Performance Measures</Link></li>
